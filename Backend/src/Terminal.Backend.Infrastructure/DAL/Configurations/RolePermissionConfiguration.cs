...
internal sealed class RolePermissionConfiguration : IEntityTypeConfiguration<RolePermission>
{
    public void Configure(EntityTypeBuilder<RolePermission> builder)
    {
        ...
        builder.HasData(Create(Role.Administrator, Permission.UserRead),
            ...
            Create(Role.Administrator, Permission.TagDelete), Create(Role.Administrator, Permission.MeasurementRead),
            Create(Role.Administrator, Permission.MeasurementWrite),
            Create(Role.Administrator, Permission.MeasurementUpdate),
            Create(Role.Administrator, Permission.MeasurementDelete),
            ...
            Create(Role.Moderator, Permission.MeasurementRead), Create(Role.Moderator, Permission.MeasurementWrite),
            Create(Role.Moderator, Permission.MeasurementUpdate), Create(Role.Moderator, Permission.MeasurementDelete),
            ...
            Create(Role.Registered, Permission.TagUpdate), Create(Role.Registered, Permission.MeasurementRead),
            Create(Role.Registered, Permission.MeasurementWrite), Create(Role.Registered, Permission.MeasurementUpdate),
